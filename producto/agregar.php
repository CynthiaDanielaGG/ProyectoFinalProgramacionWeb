            ...
            <form role="form" name="f1" id="registerform" action="agregar.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombre" placeholder="Introduce el nombre del producto" name="nombre">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Descripcion:</label>
                  <input type="areatext" class="form-control" name="descripcion" id="descripcion" placeholder="Descripcion" row="5">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Precio de compra</label>
                  <input type="text" class="form-control" name="precioc" id="precioc" placeholder="Precio de compra">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Precio de venta</label>
                  <input type="text" class="form-control" name="preciov" id="preciov" placeholder="Precio de venta">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Cantidad</label>
                  <input type="text" class="form-control" name="cantidad" id="cantidad" placeholder="Cantidad del producto">
                </div>
...
if(isset($_POST['registrar'])){
  ...
  echo "<script>alert('".$nombre.",".$descripcion.",".$precio_compra.",".$precio_venta.",".$cantidad.",".$ruta."')</script>";

  if($nombre!="" && $descripcion!="" && $precio_compra!="" && $precio_venta!=""
  && $cantidad!="" && $ruta!="" ){

    $query=mysqli_query($con,"SELECT * FROM producto WHERE nombre ='".$nombre."'");
    $numrows=mysqli_num_rows($query);
    if($numrows==0){
      $sql="INSERT INTO producto(nombre,descripcion,precio_venta,precio_compra,cantidad,imagen)VALUES('".$nombre."','".$descripcion."',".$precio_venta.",".$precio_compra.",".$cantidad.",'".$ruta."')";
                      ...
                      $result=mysqli_query($con,$sql);
                    	...
                    	if($result){
                    	 echo"<script>alert('Producto registrado exitosamente')</script>";
                    	  ...
                    	  echo"<script>alert('Producto ya existente')</script>";
                    	}
