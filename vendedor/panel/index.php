...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Mobilario</b>WEB</span>
    </a>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <p>Tengo problemas al generar factura?</p>
                    </a>
                  </li>
                </ul>
              </li>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 5 nuevos clientes
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-warning text-yellow"></i> Completar perfil
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-red"></i> 5 nuevos productos
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 ventas
                    </a>
                  </li>
                </ul>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Panel de administrador de Vendedor
        <small>Gestione ventas, rentas, clientes y mas...</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="#" class="small-box-footer">Mas informacón <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="http://almsaeedstudio.com">Mobilario Tec</a>.</strong> Todos los derechos reservados.
  </footer>
